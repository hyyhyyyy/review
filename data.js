    ...
    fill: [
      {
        ...
        bl: [
          {t:"The bank's credit rating has been downgraded because of concerns about _______.",a:"undercapitalization",h:"资本不足",cn:"由于对资本不足的担忧，该银行的信用评级已被下调。",tm:"concerns about _______"},
          {t:"Each shareholder, or _______, of a corporation is entitled to vote at the corporate meeting for the election of officers.",a:"stockholder",h:"股东",cn:"公司的每一位股东都有权在公司会议上投票选举高管。",tm:"shareholder, or _______, of (股东)"},
          {t:"Women now represent almost 50% of the _______.",a:"workforce",h:"劳动力",cn:"女性现在几乎占劳动力的50%。",tm:"50% of the _______"},
          {t:"When it comes to purchasing a new laptop, _______ matters.",a:"customer service",h:"客户服务",cn:"购买新笔记本电脑时，客户服务很重要。",tm:"_______ matters"},
      ...
      },
      {
        ...
        bl: [
          {t:"The company did not do enough to _______ that oversight measures were effective.",a:"ensure",h:"确保",cn:"公司没有做足够的工作来确保监督措施是有效的。",tm:"_______ that oversight measures"},
          {t:"How much each person _______ needs to save depends on his or her expected retirement income and lifestyle.",a:"ultimately",h:"最终",cn:"每个人最终需要储蓄多少取决于其预期退休收入和生活方式。",tm:"each person _______ needs"},
          {t:"According to a 2016 study by Princeton economists, nearly all of the jobs created in the _______ decade were part-time, contract, or temporary.",a:"preceding",h:"之前的",cn:"根据普林斯顿经济学家2016年的一项研究，在之前的十年中创造的几乎所有工作都是兼职、合同工或临时工。",tm:"in the _______ decade"},
          {t:"The government will also pursue a _______ of free, innovative, competitive, and transparent consumer finance markets.",a:"vision",h:"愿景",cn:"政府还将追求一个自由、创新、竞争和透明的消费者金融市场的愿景。",tm:"a _______ of free"},
          {t:"They agreed that Silicon Valley tech workers would jump at the opportunity to apply their _______ skills to campaigns.",a:"technical",h:"技术的",cn:"他们一致认为硅谷的技术人员会迫不及待地将他们的技术技能应用于竞选活动。",tm:"their _______ skills"},
          {t:"In order to develop a _______ attitude among employees, we need to get them to understand that certain rules and requests benefit everyone.",a:"cooperative",h:"合作的",cn:"为了在员工中培养合作的态度，我们需要让他们理解某些规则和要求对每个人都有益。",tm:"a _______ attitude"},
          {t:"The bride is an analyst in Boston for Ernst & Young, the _______ services firm.",a:"professional",h:"专业的",cn:"新娘是安永专业服务公司驻波士顿的分析师。",tm:"the _______ services firm"},
          {t:"The company gave older workers who wanted more time to enjoy life an _______ to working full-time.",a:"alternative",h:"替代选择",cn:"公司给了想享受生活的年长员工一个全职工作的替代选择。",tm:"an _______ to working"},
          {t:"You mustn't _______ the influence of the leader on the business, he says.",a:"underestimate",h:"低估",cn:"他说，你不能低估领导对业务的影响。",tm:"_______ the influence of"},
          {t:"For many clean energy advocates, the solution is _______.",a:"obvious",h:"明显的",cn:"对于许多清洁能源倡导者来说，解决方案是显而易见的。",tm:"the solution is _______"}
        ]
      },
      {
        ...
        bl: [
          {t:"The research _______ was as follows:",a:"process",h:"过程",cn:"研究过程如下：",tm:"The research _______ was"},
          {t:"_______ the World Bank definition, researchers sent out questionnaires to Chinese nationals.",a:"Citing",h:"引用",cn:"引用世界银行的定义，研究人员向中国国民发出了问卷。",tm:"_______ the World Bank"},
          {t:"Their annual income _______ from RMB 125,000 to 1 million.",a:"ranges",h:"范围从……到……",cn:"他们的年收入从12.5万元到100万元不等。",tm:"income _______ from RMB"},
          {t:"Researchers sent out _______ 4,000 questionnaires.",a:"approximately",h:"大约",cn:"研究人员发出了大约4000份问卷。",tm:"sent out _______ 4,000 (大约)"},
          {t:"2,610 _______ responses were collected.",a:"valid",h:"有效的",cn:"共收集到2610份有效回复。",tm:"2,610 _______ responses"},
          {t:"While putting away financial _______ for children's education, the affluent Chinese wanted the best for themselves.",a:"resources",h:"资源",cn:"富裕的中国人在为子女教育储备财务资源的同时，也想给自己最好的。",tm:"financial _______ for children's"},
          {t:"The _______ of work-life balance had taken root.",a:"notion",h:"概念",cn:"工作与生活平衡的概念已经深入人心。",tm:"The _______ of work-life"},
          {t:"If overseas investment _______ were lifted, they would also like to invest in these markets.",a:"constraints",h:"限制",cn:"如果取消海外投资限制，他们也希望投资这些市场。",tm:"investment _______ were lifted"}
        ]
      },
      {
  ...
  2: {
    ...
    fill: [
      ...
      },
      {
        ...
        bl: [
          {t:"Amazon bought _______ rights to air the United States Open tennis tournament in Britain.",a:"exclusive",h:"独家的",tm:"bought _______ rights",cn:"亚马逊购买了在英国转播美国网球公开赛的独家权利。"},
          {t:"The incident _______ the risks of installing Internet-connected microphones in the home.",a:"highlighted",h:"突显",tm:"incident _______ the risks",cn:"这一事件突显了在家中安装联网麦克风的风险。"},
          {t:"Publicly-traded companies are under heavy pressure from shareholders to focus on their core businesses and _______ profits.",a:"maximize",h:"最大化",tm:"and _______ profits",cn:"上市公司受到股东的巨大压力，要求其专注于核心业务并实现利润最大化。"},
          {t:"He made tens of millions of dollars of illegal profit by _______ the companies' stock prices, according to the investigation.",a:"manipulating",h:"操纵",tm:"by _______ the companies'",cn:"据调查，他通过操纵公司股价获取了数千万美元的非法利润。"},
          {t:"As the company grew, Ryan eventually _______ his brother to quit a product director's job at Google and run the technical side of things.",a:"convinced",h:"说服",tm:"eventually _______ his brother",cn:"随着公司的发展，瑞安最终说服他的兄弟辞去谷歌产品总监的职位，负责技术方面的工作。"},
          {t:"We must accept finite disappointment, but we must never lose _______ hope.",a:"infinite",h:"无限的",tm:"lose _______ hope",cn:"我们必须接受有限的失望，但绝不能失去无限的希望。"},
          {t:"Survey participants were asked to _______ young companies that are innovative, growing fast and expected to continue to grow fast.",a:"identify",h:"识别",tm:"to _______ young companies",cn:"调查参与者被要求识别那些创新、快速增长且预计将继续快速增长的年轻公司。"},
          {t:"A bear market is commonly _______ as a drop of 20% or more from a record or long-standing high closing level.",a:"defined",h:"定义为",tm:"commonly _______ as a",cn:"熊市通常被定义为从历史或长期高位收盘水平下跌20%或更多。"}
        ]
      },
      {
        ...
        bl: [
          {t:"Her marketing abilities proved so effective — she sold 1.4 million print and digital copies — that she decided to expand her business by taking on other authors, _______, becoming a publisher herself.",a:"in essence",h:"实质上",tm:"_______ (实质上)",cn:"她的营销能力非常有效——她卖出了140万册印刷版和电子版——以至于她决定通过接纳其他作家来扩展业务，实质上，她自己成为了出版商。"},
          {t:"After you've made the investment in finding new customers, it's important to consider how you can _______ to build your business and your customer base, and keep your customers returning.",a:"manage customer relationships",h:"管理顾客关系",tm:"_______ customer relationships (管理顾客关系)",cn:"在你投资寻找新客户之后，考虑如何管理顾客关系来建立你的业务和客户群，并让客户回头，这很重要。"},
          {t:"Companies that cannot _______ may suffer such consequences as lower sales, higher inventory and lower profitability.",a:"satisfy customer requirements",h:"满足消费者要求",tm:"_______ customer requirements (满足消费者要求)",cn:"不能满足消费者要求的公司可能会遭受销售额下降、库存增加和利润降低等后果。"},
          {t:"Any cost-saving measures initiated by a company will bring expenses down and _______.",a:"increase profitability",h:"增加利润",tm:"_______ profitability (增加利润)",cn:"公司发起的任何节约成本的措施都会降低开支并增加利润。"},
          {t:"The purpose of our study is to find out in what ways retailers _______ to buy a product.",a:"entice consumers",h:"吸引消费者",tm:"_______ consumers (吸引消费者)",cn:"我们研究的目的是找出零售商以何种方式吸引消费者购买产品。"},
          {t:"Marketing may be considered as a set of processes for creating and _______ to your customers.",a:"delivering value",h:"向客户传递价值",tm:"_______ value (传递价值)",cn:"营销可以被看作是一系列创建并向客户传递价值的过程。"},
          {t:"The newly-made policy of the company was _______ because nobody would support it.",a:"doomed to failure",h:"注定要失败的",tm:"_______ to failure (注定失败)",cn:"公司新制定的政策注定要失败，因为没有人会支持它。"},
          {t:"_______ can be an effective tool to increase your business.",a:"Expanding distribution",h:"扩大经销渠道",tm:"_______ distribution (扩大经销渠道)",cn:"扩大经销渠道可以成为增加业务的有效工具。"}
        ]
      },
      {
        ...
        bl: [
          ...
          {t:"And finally, it even _______ how you should consume the product. (Replace: indicates)",a:"conveys",h:"indicates的正式表达",tm:"it even _______ how",cn:"最后，它甚至传达了你应该如何消费该产品。"},
          {t:"These are important strategic decisions that influence how your product is _______ and the price consumers will be willing to pay for it. (Replace: considered / viewed)",a:"perceived",h:"considered/viewed的正式表达",tm:"product is _______",cn:"这些是影响你的产品如何被看待以及消费者愿意为其支付多少价格的重要战略决策。"}
        ]
      }
    ],
    trans: {
    ...
    fill: [
      {
        ...
        bl: [
          {t:"New Retail is a _______ that bridges e-commerce, physical retail, and logistics in order to improve the efficiency of selling and buying, as well as improving customers' shopping experience.",a:"transformative business model",h:"变革型商业模式",tm:"is a _______ that",cn:"新零售是一种变革型商业模式，它连接电子商务、实体零售和物流，以提高买卖效率，同时改善客户的购物体验。"},
          {t:"China is leading this revolution thanks to its strong consumer base, increasing purchasing power, and the widespread use of mobile _______.",a:"payment transactions",h:"付款交易",tm:"mobile _______",cn:"中国引领这场革命，得益于其强大的消费者基础、不断增长的购买力以及移动支付交易的广泛使用。"},
          {t:"Big data stands at the core of New Retail. Data on consumers' preferences, sales, and _______ enables efficient delivery to consumers and reduces surplus inventory.",a:"in-store experiences",h:"店内体验",tm:"sales, and _______",cn:"大数据是新零售的核心。关于消费者偏好、销售额和店内体验的数据使得向消费者高效配送成为可能，并减少了库存积压。"},
          {t:"The integration of _______ and logistics creates an omni-channel shopping experience, expanding the consumer base and increasing revenues.",a:"online and offline channels",h:"线上和线下渠道",tm:"of _______ and logistics",cn:"线上和线下渠道与物流的整合创造了全渠道购物体验，扩大了消费者群体并增加了收入。"},
          {t:"The most important thing to keep in mind is to understand what motivates consumers to visit _______ and buy.",a:"physical stores",h:"实体店",tm:"visit _______ and buy",cn:"要记住的最重要的事情是了解什么动机驱使消费者去实体店购买。"}
        ]
      },
      {
      ...
      },
      {
        ...
        bl: [
          {t:"The company needs to take actions _______ the new challenge — dedication to advanced analytics may require changing management styles and human resources policies.",a:"in the face of",h:"面对",tm:"_______ the challenge (面对)",cn:"公司需要面对新挑战采取行动——致力于高级分析可能需要改变管理风格和人力资源政策。"},
          {t:"Global strategists need to go beyond such traditional questions as which markets are 'closest' to them _______ institutions, level of development and culture.",a:"in terms of",h:"就……而言",tm:"_______ institutions (就…而言)",cn:"全球战略家需要超越'哪些市场在制度、发展水平和文化方面与他们最接近'这类传统问题。"},
          {t:"Yelp, the reviews site for local businesses, is a common place for customers to talk about their experiences, and business owners often _______ people there.",a:"engage with",h:"与……互动",tm:"_______ people (与…互动)",cn:"Yelp是本地企业的评论网站，是顾客谈论体验的常见场所，企业主经常在那里与人们互动。"},
          {t:"By the acquisition of IBM's PC division in 2005, Lenovo Group's assets _______ a new set of capabilities so as to improve the company's advantage in international markets.",a:"were combined with",h:"与……结合",tm:"_______ with (与…结合)",cn:"通过2005年收购IBM的个人电脑部门，联想集团的资产与一组新的能力相结合，以提升公司在国际市场上的优势。"},
          {t:"Marketing departments _______ on customer behavior and what competitors are doing.",a:"leverage data",h:"利用数据",tm:"_______ data (利用数据)",cn:"营销部门利用有关消费者行为和竞争对手动态的数据。"},
          {t:"Social networks and media are not simply promotional tools for organizations to attempt to _______.",a:"build brands",h:"建立品牌",tm:"_______ brands (建立品牌)",cn:"社交网络和媒体不仅仅是组织试图建立品牌的推广工具。"},
          {t:"While a company's home-developed capabilities allowed it to enter and survive in the foreign market, its subsequent efforts frequently require the development of capabilities _______ the new host country.",a:"specific to",h:"针对……的",tm:"_______ to the host country (针对…的)",cn:"虽然公司自主开发的能力使其能够进入并在外国市场中生存，但其后续努力往往需要开发针对新东道国的能力。"}
        ]
      },
      {
        ...
        bl: [
          {t:"Talk about the decline of the UK High Street is rife, and it's easy to think that the future of retail is _______ about the rise of e-commerce. (Replace: exclusively)",a:"only",h:"exclusively的日常表达",tm:"_______ about (exclusively → 只)",cn:"关于英国高街衰落的讨论比比皆是，人们很容易认为零售的未来仅仅关于电子商务的崛起。"},
          {t:"Now the biggest single shopping event in the world by a _______ margin, this year's event not only generated record-breaking revenues of $25.4 billion, but crucially enabled the brands taking part to engage with their customers in many different innovative and immersive ways. (Replace: substantial)",a:"very large",h:"substantial的日常表达",tm:"by a _______ margin (substantial → 很大的)",cn:"现在以非常大的优势成为世界上最大的单一购物活动，今年的活动不仅创造了254亿美元的创纪录收入，而且关键地使参与品牌能够以许多不同的创新和沉浸式方式与客户互动。"},
          {t:"Across the 24 hours of 11.11, China's _______ 300 million middle class took to their smartphones and made 1.5 billion payment transactions. (Replace: burgeoning)",a:"rapidly growing",h:"burgeoning的日常表达",tm:"_______ middle class (burgeoning → 快速增长的)",cn:"在双十一的24小时内，中国快速增长的三亿中产阶级拿起智能手机，完成了15亿笔支付交易。"},
          {t:"A closer look at the success of 11.11 and the principles of New Retail that _______ it shows that there are real opportunities for all retailers to attract new customers. (Replace: underpin)",a:"support it as a basis",h:"underpin的日常表达",tm:"_______ it (underpin → 支持)",cn:"仔细审视双十一的成功及其作为基础支撑的新零售原则，可以发现所有零售商都有真正的机会吸引新客户。"},
          {t:"At this year's 11.11 Global Shopping Festival around 100,000 'smart stores' helped merchants to deliver that _______ shopping service in 334 cities across China. (Replace: bespoke)",a:"tailored",h:"bespoke的日常表达",tm:"_______ service (bespoke → 定制的)",cn:"在今年的双十一全球购物节上，大约10万家'智慧门店'帮助商家在中国334个城市提供量身定制的购物服务。"},
          {t:"Hema has digitalised the entire store providing consumers with a 3-in-1 retail experience that _______ all modes and desires of modern urban shoppers. (Replace: encompasses)",a:"includes",h:"encompasses的日常表达",tm:"_______ all modes (encompasses → 包含)",cn:"盒马对整个店铺进行了数字化改造，为消费者提供三合一的零售体验，包含了现代城市购物者的所有模式和需求。"}
        ]
      },
      {
        ...
        bl: [
          {t:"Since the firm does not observe its competitors' actions _______ choosing its own action, it makes decisions based on its expectations.",a:"prior to",h:"在……之前",tm:"_______ choosing (在…之前)",cn:"由于公司在选择自己的行动之前没有观察到竞争对手的行动，它根据自己的预期做出决策。"},
    ...
    fill: [
      ...
      },
      {
        ...
        bl: [
          ...
          {t:"Managers should _______ that it is necessary for companies to pursue business model innovation.",a:"bear in mind",h:"记住",cn:"管理者应该记住，公司有必要追求商业模式创新。",tm:"_______ in mind (记住)"},
          {t:"Smart entrepreneurs have to _______ multiple escalating market tests, each building upon the previous test.",a:"go through",h:"经历",cn:"聪明的企业家必须经历多个逐步升级的市场测试，每一个都建立在前一个测试的基础之上。",tm:"_______ market tests (经历)"},
          {t:"Three employees refused to _______ the new regulations of the start-up company.",a:"comply with",h:"遵守",cn:"三名员工拒绝遵守这家初创公司的新规定。",tm:"_______ regulations (遵守)"}
        ]
      },
      {
        title: "Task 4 / Formal English",
        ...
        bl: [
          {t:"In markets exposed to this new force, the effect is likely to be deflationary — to the great benefit of consumers and to the _______ of traditional suppliers. (Replace: detriment)",a:"harm / damage",h:"detriment的日常表达",cn:"在受到这一新力量影响的市场中，效果可能是通缩性的——对消费者大大有利，但对传统供应商造成伤害。",tm:"to the _______ of (detriment → 损害)"},
      ...
      },
      {
        ...
        bl: [
          {t:"In today's knowledge-based economy, managerial authority is _______ declining, but there is still a strong need for someone to define and implement the organizational rules of the game.",a:"in theory",h:"按理论说",cn:"在当今的知识经济中，管理权威按理论说正在衰落，但仍然强烈需要有人来定义和实施组织的游戏规则。",tm:"_______ declining (按理论说)"},
          {t:"Executives are _______ more frequently to make operating decisions.",a:"stepping in",h:"介入",cn:"高管们正在更频繁地介入以做出运营决策。",tm:"_______ more frequently (介入)"},
          {t:"Growing customer _______ new products can enhance a company's innovation.",a:"demand for",h:"对……的需求",cn:"不断增长的客户对新产品的需求可以增强公司的创新能力。",tm:"_______ for new products (对…的需求)"},
          {t:"Consulting services can reveal the gaps between what customers want and what the firm is offering; addressing such gaps can _______ innovation.",a:"lead to",h:"引起",cn:"咨询服务可以揭示客户需求与公司提供之间的差距；解决这些差距可以引起创新。",tm:"gaps can _______ innovation (引起)"},
          {t:"The manager _______ accessing the company's financial reports.",a:"was banned from",h:"被禁止做……",cn:"该经理被禁止访问公司的财务报告。",tm:"_______ from accessing (被禁止做…)"},
          {t:"Customization benefits can _______ on consumers' information disclosures.",a:"generate an impact",h:"产生影响",cn:"定制化好处可以对消费者的信息披露产生影响。",tm:"_______ an impact on (产生影响)"},
          {t:"The top management team needs to _______ decisions for adapting new business model.",a:"come up with",h:"提出",cn:"高管团队需要提出适应新商业模式的决策。",tm:"_______ with decisions (提出)"},
          {t:"Consulting firms can provide valuable resources _______ knowledge or legitimacy based on their expertise and experience.",a:"in the form of",h:"以……形式",cn:"咨询公司可以基于其专业知识和经验，以知识或合法性的形式提供有价值的资源。",tm:"_______ the form of (以…形式)"}
        ]
      }
    ],
    trans: {
  ...
  5: {
    ...
    fill: [
      ...
      },
      {
        ...
        bl: [
          {t:"_______ consumers, the sharing economy seems to hold the potential to unite cost reduction, benefit augmentation, convenience and environmental consciousness in one mode of consumption.",a:"When it comes to",h:"当谈到……",cn:"当谈到消费者时，共享经济似乎有潜力将降低成本、增加收益、便利性和环保意识统一在一种消费模式中。",tm:"_______ consumers (当谈到…)"},
          {t:"The HR manager explains that employees may _______ the company's pension plan.",a:"opt out of",h:"选择不参加",cn:"人力资源经理解释说，员工可以选择不参加公司的养老金计划。",tm:"_______ of the pension plan (选择不参加)"},
          {t:"_______ the launch of the used furniture marketplace has multiple advantages for the furniture company.",a:"In the long term",h:"从长远来看",cn:"从长远来看，推出二手家具市场对这家家具公司有多种优势。",tm:"_______ the launch (从长远来看)"},
          {t:"The sharing economy might _______ established industries, due to fewer purchases and consequent distress in conventional markets.",a:"shake up",h:"重组；整顿",cn:"由于购买减少和传统市场随之而来的困境，共享经济可能会重组成熟行业。",tm:"_______ established industries (重组；整顿)"},
          {t:"The German company recently _______ the new approach to aligning with peer-to-peer sharing as a platform to promote its products and services to potential customers.",a:"experimented with",h:"尝试",cn:"这家德国公司最近尝试了与点对点分享相一致的新方法，将其作为向潜在客户推广产品和服务的平台。",tm:"_______ with the approach (尝试)"},
          {t:"Although its rapid market penetration and growth are indisputable, the company did not initially _______ traditional approaches to diversification.",a:"depend on",h:"依赖",cn:"尽管其快速的市场渗透和增长是无可争议的，但该公司最初并不依赖传统的多元化方法。",tm:"_______ on traditional approaches (依赖)"},
          {t:"Companies can benefit from the trend toward collaborative consumption by _______ developing entirely new business models.",a:"branching out into",h:"拓展到",cn:"公司可以通过拓展到开发全新商业模式来从协作消费趋势中受益。",tm:"_______ out into new models (拓展到)"},
          {t:"The American company is _______ to transform the vehicle rental services.",a:"in pole position",h:"处于主导地位",cn:"这家美国公司处于主导地位来改变汽车租赁服务。",tm:"_______ to transform (处于主导地位)"}
        ]
      },
      {
        title: "Task 4 / Formal English",
